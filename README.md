...
char hardword[58][1000] = {"The story of a girl named Alice who falls down a rabbit hole into a fantasy world populated by peculiar and anthropomorphic creatures. The tale is filled with allusions to Dodgson's friends. The tale plays with logic in ways that have given the story lasting popularity with adults as well as children. It is considered to be one of the most characteristic examples of the genre of literary nonsense, and its narrative course and structure have been enormously influential, especially in the fantasy genre",
...
void *Countdowntime(void *vargp)
{
    while (countdown >= 0)
    {
        char text[20] = "", text2[20] = "JustTYPE | Time: ", text3[20] = "";
...
void *myThreadFunf(void *vargp)
{
    ...
    if (choicefew == 1)
    {
        ...
        text1 = easyword[randomfew(37, 0)];
    }
    else if (choicefew == 2)
    {
        text1 = mediumword[randomfew(54, 0)];
    }
    else if (choicefew == 3)
    {
        text1 = hardword[randomfew(56, 0)];
    }
...
int main()
{
    SetConsoleTitle("Welcome To JustTYPE");
